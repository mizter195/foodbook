...
$(document).ready(function () {
    ...
    $('#email').val(data.message.body.email);
    $('#password').val(data.message.body.password);
    $('#username-edit').val(data.message.body.username);
    $('#name').val(data.message.body.name);
    $('#sex').val(data.message.body.sex);
    $('#age').val(data.message.body.age);
    $('#avatar').val(data.message.body.avatar);

    $("#form-edit").submit(function(e) {
        e.preventDefault(); // avoid to execute the actual submit of the form.
        var url = "/users/edit"; // the script where you handle the form input.
        ...
        $.ajax({
            ...
            success: function(data)
            {
                if(data.status != 200){
                    ...
                    calLogin(data.message.username,data.message.password)

...
$(function () {
        ...
        var user_id = ((jQuery.parseJSON(data)).message.body.id)
    $.ajax({
        type:'GET',
        url:'/reviews/userid',
        data:{
        ...
        success:function (allReviews) {
                $.each(allReviews.message, function (i) {
                    console.log(allReviews.message[i].id)
                                $('#allReview').append(`
                    <tr>
                               <td>` + allReviews.message[i].id + `</td>
                               <td>` + allReviews.message[i].title + `</td>
                               <td>` + allReviews.message[i].address + `</td>
                               <td>` + allReviews.message[i].content + `</td>
                               <td>` + allReviews.message[i].rate + `</td>
                               <td>` + allReviews.message[i].user_id + `</td>
                               <td>` + allReviews.message[i].is_pending + `</td>
                                <td>` + allReviews.message[i].createdAt + `</td>
                               <td>` + allReviews.message[i].updatedAt + `</td>
                                <td><a href="#" onclick="Comment(` + allReviews.message[i].id + `)">Delete</a></td>
                               </tr>
                    `)
                            })

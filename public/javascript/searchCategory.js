...
$(document).ready(function () {
    ...
    var id= getUrlParameter('cate-id')
    $.getJSON('/reviews/reviewbycategory?category_id='+id).then(function (results) {
            if(results.message == 'No record!'){
                $('#allReviews').empty();
            }
            else {
				...
				<a href="#" data-toggle="tooltip" data-placement="right" title="Star"><i class="fa fa-star"></i> `+ rates.message.score +`</a>
				</span>
